...
function ProofApp() {
  ...
  return (
    <main className="relative min-h-screen bg-zinc-950 text-zinc-100 flex items-center justify-center p-6">
      {/* GitHub Icon - Top Right */}
      <a
        href="https://github.com/tanghaosuan11/shutup"
        target="_blank"
        rel="noopener noreferrer"
        className="absolute top-6 right-6 inline-flex items-center justify-center w-10 h-10 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-400 hover:text-zinc-100 transition-colors"
